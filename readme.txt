...
I prefer using Visual Studio projects. But there are CMake files if you prefer using CMake. There is no need of any external library: windows SDK and std library is enough. But a C++17 standard compiler is needed.
In bin directory there is a couple of executables to check how it works without building.
